...
return(
    ...
    <Card className='packages__shadow'>
        ...
        <div className="row">
            <div className="col-12">
                <h1 style={{marginBottom: '1rem', marginTop: '1rem',fontFamily: 'AlexBrush',  fontSize: '5rem'}}>Add-Ons</h1>
        ...
        <div className="row">
            <div className="col-12">
            <h1 style={{marginBottom: '1rem', marginTop: '1rem',fontFamily: 'AlexBrush',  fontSize: '5rem'}}>Additional Event Coverage</h1>
            <p>We also do corporate events and family shoots.</p>
            </div>
        </div>
